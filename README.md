...
- Dockerized microservice polling AWS SQS  
- FFmpeg for:
  - Transcoding  
  - Segmentation  
...
This pipeline supports scalable, fault-tolerant video streaming, similar to platforms like YouTube, Vimeo, and Hotstar.
